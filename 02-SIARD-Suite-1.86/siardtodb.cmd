@echo off
rem ==$Workfile: siardtodb.cmd $========================================
rem  siardtodb executes ch.admin.bar.siard.SiardToDb in bin/SiardEdit.jar. 
rem  Version    : $Id: siardtodb.cmd 1643 2014-09-11 13:26:08Z hartwig $
rem  Application: Siard2
rem  Platform   : Win32
rem --------------------------------------------------------------------
rem Copyright  : Swiss Federal Archives, Berne, Switzerland, 2008, 2011
rem Created    : 30.03.2008, Hartwig Thomas
rem ====================================================================
chcp 1252
if "%~1"=="-?" goto help
if "%~1"=="/?" goto help
